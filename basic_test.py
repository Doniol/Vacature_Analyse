class test:
    ...
    def calc_score(self, incorrect_weight, missing_weight):
        ...
        min_score = incorrect_weight * unnecessary_results + missing_weight * missing_answers

        return unnecessary_results, missing_answers, min_score