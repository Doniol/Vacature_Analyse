...
class AI():
    def __init__(self):
        ...
        self.num_to_word_converter = dict((num, word) for num, word in enumerate(words))

        self.x_data = [[word_to_num_converter[word] for word in words]]
        self.y_data = [[word_to_num_converter[word] for word in ["informatietechnologie", "netwerkbeheerder", "ict", "specialist", "it", "infrastructuur", 
